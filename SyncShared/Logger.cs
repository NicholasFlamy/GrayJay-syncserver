...
public static class Logger
{
    ...
    public static void Info<T>(string message, Exception? ex = null) => LogCallback.Invoke(LogLevel.Info, nameof(T), message, ex);
    public static void Warning<T>(string message, Exception? ex = null) => LogCallback.Invoke(LogLevel.Warning, nameof(T), message, ex);
    public static void Error<T>(string message, Exception? ex = null) => LogCallback.Invoke(LogLevel.Error, nameof(T), message, ex);
